...
import { useEffect, Dispatch, SetStateAction, useCallback, memo, useMemo } from 'react';
...
const CategoryStats = ({items}:catStatsProp) => {
    ...
    return (
        ...
        {category && <>
            ...
            <span>First added time date: <i>in-progress</i></span>
            <span>Most active month: <i>in-progress</i></span>
            <span>Most active day of the week: <i>in-progress</i></span>
            <span style={{marginTop: '8px'}} >Average spent hours per month: <i>in-progress</i></span>
